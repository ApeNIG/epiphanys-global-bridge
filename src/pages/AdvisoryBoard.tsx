...
const AdvisoryBoard = () => (
  <div className="min-h-screen bg-[#15171A] flex flex-col items-center justify-center px-6 text-center">
    ...
    <span className="text-[11px] font-semibold tracking-[3px] uppercase text-gray-500 mb-6 block">Advisory</span>
    ...
    <p className="text-gray-500 text-[17px] leading-[1.7] max-w-[420px]">
      Meet the experts and leaders guiding our mission to empower diaspora communities globally. Coming soon.
    </p>
