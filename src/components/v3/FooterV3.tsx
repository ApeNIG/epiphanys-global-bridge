            ...
            <div className="flex items-center gap-2 mt-1">
              {[
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-full border border-white/[0.08] flex items-center justify-center hover:border-[#00E7C3]/40 hover:bg-[#00E7C3]/5 transition-colors"
                >
              ...
              {links.map((link) =>
                link.href.startsWith("/") && link.href !== "#" ? (
                  <Link
                    key={link.label}
                    to={link.href}
                    className="text-[13px] text-gray-600 hover:text-[#00E7C3] transition-colors"
                  >
                    {link.label}
                  </Link>
                ) : (
