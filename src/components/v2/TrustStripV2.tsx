...
const TrustStripV2 = () => {
  ...
  return (
    <section className="relative">
      <div className="bg-[#F5F0E8] pt-24 md:pt-32 pb-20 md:pb-24">
        <div
          ref={ref}
          className="reveal-up max-w-[1440px] mx-auto px-6 md:px-20"
        >
          {/* Editorial boardroom image */}
          <div className="rounded-2xl overflow-hidden h-[240px] md:h-[360px] mb-14 -mt-8">
            <img
              src={boardroomMeeting}
              alt="Diaspora professionals collaborating in a London boardroom"
          ...
          <div className="max-w-[1000px]">
            ...
            <h2 className="font-serif text-[clamp(1.75rem,4vw,2.75rem)] text-[#15171A] leading-[1.35]">
              ...
              <em className="not-italic text-[#00E7C3]">unlocks opportunities</em>,</span>
              <span className="block">celebrates cultural identity, and drives{" "}
              <em className="not-italic text-[#8B5CF6]">collaborative growth</em></span>
